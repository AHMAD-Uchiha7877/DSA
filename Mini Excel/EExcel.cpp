...
#ifdef _WIN32
// Include for strlen on Unix-based systems
#endif
...
public:
    ...
    void insertColumnToLeft()
    {
        ...
        // Create the first cell of the new column
       ...
       // cout << "-";
        ...
        while (rowStart)
        {
            ...
            while (colStart)
            {
                ...
                {
                    // Set color for cell data
                    setConsoleColor(14);                             // Yellow
                    cout << "|" << setw(5) << colStart->data << " "; // Increase cell size
                    // Set color for the border
                    setConsoleColor(11); // Bright cyan
                    cout << "|";
                    resetConsoleColor();
